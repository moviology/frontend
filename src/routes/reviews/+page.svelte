...
<center><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" style="background-color:#5C728A;margin-top:0.5em;margin-bottom:0.5em;">
 ...
 <!-- <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" style="background-color:#5C728A;margin-top:0.5em;margin-bottom:0.5em;">
    ...
    <div style="margin-left:1em;padding-bottom:1em;border-radius:1em;display:inline-block;background-color:whitesmoke;border:none" class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700" >
        ...
        <div class="p-5" style="margin-left:1em;margin-right:1em;overflow-y:scroll">
            ...
            {:else}
            <h2 style="font-size:1.2em;" class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Status: <span style="color:red">Incomplete</span> </h2>
            {/if}
            <h2 style="font-size:1.2em;display:inline-block;margin-bottom:-0.2em;" class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Date of review:</h2> <span style="font-size:1.2em">{review.review_date}</span>
            <h2 style="font-size:1.2em;display:inline-block;margin-bottom:0.3em;" class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Date booked:</h2> <span style="font-size:1.2em">{review.date_booked}</span>

            <ul style="margin-top:-0.5em;margin-bottom:0.5em;">
        <h2 style="font-size:1.2em;display:inline-block" class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Genres: </h2>
        ...
        <form action="/biodata/" on:submit={() => updateReviewId(review._id)}>
            <input type="submit" value="View Movie"style="background-color:#5C728A;cursor:pointer;margin-top:0.5em;" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" />
        </form>
